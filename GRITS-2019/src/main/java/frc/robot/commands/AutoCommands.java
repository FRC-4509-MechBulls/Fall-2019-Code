...
public class AutoCommands extends CommandGroup {
    public AutoCommands() {
        ...
        addSequential(new DriveAutonomousCommand(2.3,-0.75,0));
        addSequential(new DriveAutonomousCommand(0.20,0,-.45));
        addSequential(new DriveAutonomousCommand(1.30,-0.75,0));
        addSequential(new DriveAutonomousCommand(.45,0,0.75));
